            ...
            <div class="card-body">
                <div class="card-block">
                    <div class="media">
                        ...
                        <div class="media-right media-middle">
                            <i class="icon-user-check cyan font-large-2 float-xs-right"></i>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row match-height">
    <div class="col-xl-4 col-md-6 col-sm-12">
        <div class="card" style="height: 440px;">
            <div class="card-body">
                <img class="card-img-top img-fluid" src="<?= base_url() ?>assets/app-assets/images/carousel/05.jpg" alt="Card image cap">
                <div class="card-block">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item">
                            <img src="<?= base_url() ?>assets/app-assets/images/carousel/02.jpg" alt="First slide">
                        </div>
                        <div class="carousel-item active">
                            <img src="<?= base_url() ?>assets/app-assets/images/carousel/03.jpg" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= base_url() ?>assets/app-assets/images/carousel/01.jpg" alt="Third slide">
                        </div>
                    </div>
    ...
    <footer class="footer footer-static footer-light navbar-border">
      <p class="clearfix text-muted text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 2017 <a href="<?= base_url('122.22.22.22') ?>" target="_blank" class="text-bold-800 grey darken-2">Froura </a>, All rights reserved. </span><span class="float-md-right d-xs-block d-md-inline-block">Hand-crafted & Made with <i class="icon-heart5 pink"></i></span></p>
    </footer>
