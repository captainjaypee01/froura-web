  ...
  <div class="card border-grey border-lighten-3 m-0">
      ...
      <div class="card-body collapse in">
          <div class="card-block">
              <form class="form-horizontal form-simple" action="<?= base_url()?>execute/loginp" method="POST">
      ...
      <div class="card-footer">
          <div class="">
              <p class="float-sm-right text-xs-center m-0">New to Froura? <a href="<?= base_url('passenger/register') ?>" class="card-link">Sign Up</a></p>
          </div>
      </div>
  </div>
</div>
