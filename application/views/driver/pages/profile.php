                 ...
                 <div class="card-body collapse in">
                     <div class="card-block">
                         ...
                         <div class="card-text">
                             ...
                             <div class="form-body">
                                 <form method="POST" action="<?= base_url() ?>execute/saveimage_driver" enctype="multipart/form-data">
                                    <h4 class="form-section"><i class="icon-camera5"></i> Profile Picture</h4>
                                    
                                    <img src="<?= $user->img_path == "" ? base_url().'assets/app-assets/images/avatar.jpg' : base_url().'uploads/driver/'.$user->img_path ?>" id="blah" width="150px" height ="150px">
                                 ...
                                 <form class="form" method="POST" action="<?= base_url() ?>execute/updatedriver" enctype="multipart/form-data">
